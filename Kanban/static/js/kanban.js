$(document).ready(() => {
    ...
    const createIconButton = (iconClass, bntnClasses, clickHandler) => {
        const $button = $("<button></button>").addClass(bntnClasses);
    ...
    const addTaskToBoard = (description, board) => {
        const $newTask = $("<div></div>").appClass("kanban-item");
